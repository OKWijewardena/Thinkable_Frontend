...
const stripe = new Stripe(
  "sk_test_51NxmUQJSn6JcxC7Vt2kGKXaaA7maL4adID8CeHF5UrllHiwXX1o4T4y47pP9LlUQfGKL8K62zm1Vu3crspfqEUP400DReYLtTk"
);
  ...
  function CheckoutForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        console.log(
          "Profile Updated with new membership balance:",
          totalBalance
        );
                    ...
                    <div className="blog-one__single">
                      ...
                      <div className="blog-one__content">
                        <ul className="blog-one__meta list-unstyled">
                          ...
                          <li>
                            <a href="#">{plan.description}</a>
                          </li>
                        </ul>
                        <h3 className="blog-one__title">
                          {plan.time_period_months} Months
                        </h3>
                    ...
                    <PayPalButtons
                      ...
                      onApprove={async (data, actions) => {
                        try {
                          ...
                          const endDate = new Date(startDate);
                          endDate.setMonth(
                            endDate.getMonth() + selectedPlan.time_period_months
                          );

                          if (!profileId) {
                            console.error("User document ID not found!");
                            alert(
                              "User authentication issue. Please log in again."
                            );
                            return;
                          }
                          ...
                          alert(
                            `Payment successful for ${selectedPlan.name}! Subscription activated.`
                          );
                        } catch (error) {
                          console.error(
